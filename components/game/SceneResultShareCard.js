...
// seri ve WatchFlix marka alani gosterilir. Saf/statik bilesendir (animasyon/buton
  ...
  return (
    <View style={[styles.root, { width, height, borderRadius: u(28) }]}>
      ...
      <View style={[styles.watermark, { bottom: u(14), right: u(16), paddingRight: u(11), borderRadius: u(999) }]}>
        ...
        <Text style={[styles.wmText, { fontSize: u(12) }]} allowFontScaling={false}>WatchFlix</Text>
      </View>
    </View>
  );
});
