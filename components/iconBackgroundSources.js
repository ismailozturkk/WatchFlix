// components/iconBackgroundSources.js
//
// 174 yerel desen görseli. AYRI DOSYADA OLMASININ SEBEBİ: ikon arka planı
// varsayılan KAPALI bir tercih ama bu require'lar modül yüklenirken çalışır.
// IconBacground.js 10 ekrandan import ediliyor; listeyi orada tutmak, deseni
// hiç açmayan kullanıcıya da 174 asset kaydını açılışta ödetiyordu. Burada
// durunca IconBacground bu modülü YALNIZ desen gerçekten çizileceği zaman
// (veya grup avatarı seçilirken) lazy require ediyor.
//
// Sıra sözleşmesi: index 0 → 1.png … index 173 → 174.png. Grup avatarı
// seçimi bu 0-tabanlı indeksi Firestore'a yazıyor — SIRAYI DEĞİŞTİRME.
const ICON_BACKGROUND_SOURCES = [
...
export default ICON_BACKGROUND_SOURCES;
