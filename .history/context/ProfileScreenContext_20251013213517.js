...
export const ProfileScreenProvider = ({ children }) => {
  ...
  const getRankColor = (totalWatchedTime) => {
    if (totalWatchedTime < 21600)
      return {
        borderColorMovies: "#A9A9A9",
        borderColor2Movies: "#D3D3D3",
        shadowColorMovies: "rgba(169, 169, 169, 0.9)",
      }; // Gri - Başlangıç
    if (totalWatchedTime < 43200)
      return {
        borderColorMovies: "#cd7f32",
        borderColor2Movies: "#b87333",
        shadowColorMovies: "rgba(205, 127, 50, 0.9)",
      }; // Bronz
    if (totalWatchedTime < 64800)
      return {
        borderColorMovies: "#C0C0C0",
        borderColor2Movies: "#DCDCDC",
        shadowColorMovies: "rgba(192, 192, 192, 0.9)",
      }; // Gümüş
    if (totalWatchedTime < 86400)
      return {
        borderColorMovies: "#FFD700",
        borderColor2Movies: "#FFC300",
        shadowColorMovies: "rgba(255, 215, 0, 0.9)",
      }; // Altın
    if (totalWatchedTime < 108000)
      return {
        borderColorMovies: "#50C878",
        borderColor2Movies: "#32CD99",
        shadowColorMovies: "rgba(80, 200, 120, 0.9)",
      }; // Zümrüt
    if (totalWatchedTime < 129600)
      return {
        borderColorMovies: "#0F52BA",
        borderColor2Movies: "#1E90FF",
        shadowColorMovies: "rgba(15, 82, 186, 0.9)",
      }; // Safir
    if (totalWatchedTime < 151200)
      return {
        borderColorMovies: "#B9F2FF",
        borderColor2Movies: "#E0FFFF",
        shadowColorMovies: "rgba(185, 242, 255, 0.9)",
      }; // Elmas
    if (totalWatchedTime < 172800)
      return {
        borderColorMovies: "#9966cc",
        borderColor2Movies: "#BA55D3",
        shadowColorMovies: "rgba(153, 102, 204, 0.9)",
      }; // Amethyst
    if (totalWatchedTime < 194400)
      return {
        borderColorMovies: "#FF4500",
        borderColor2Movies: "#FF6347",
        shadowColorMovies: "rgba(255, 69, 0, 0.9)",
      }; // Kızıl
    if (totalWatchedTime < 216000)
      return {
        borderColorMovies: "#8A2BE2",
        borderColor2Movies: "#9370DB",
        shadowColorMovies: "rgba(138, 43, 226, 0.9)",
      }; // Galaksi
    if (totalWatchedTime < 237600)
      return {
        borderColorMovies: "#FF1493",
        borderColor2Movies: "#FF69B4",
        shadowColorMovies: "rgba(255, 20, 147, 0.9)",
      }; // Pembe
    if (totalWatchedTime < 259200)
      return {
        borderColorMovies: "#7FFFD4",
        borderColor2Movies: "#66CDAA",
        shadowColorMovies: "rgba(127, 255, 212, 0.9)",
      }; // Akuamarin
    if (totalWatchedTime < 280800)
      return {
        borderColorMovies: "#00CED1",
        borderColor2Movies: "#40E0D0",
        shadowColorMovies: "rgba(0, 206, 209, 0.9)",
      }; // Turkuaz
    if (totalWatchedTime < 302400)
      return {
        borderColorMovies: "#FF69B4",
        borderColor2Movies: "#FFB6C1",
        shadowColorMovies: "rgba(255, 105, 180, 0.9)",
      }; // Tatlı Pembe
    if (totalWatchedTime < 324000)
      return {
        borderColorMovies: "#DC143C",
        borderColor2Movies: "#B22222",
        shadowColorMovies: "rgba(220, 20, 60, 0.9)",
      }; // Koyu Kırmızı
    return {
      borderColorMovies: "#000000",
      borderColor2Movies: "#434343",
      shadowColorMovies: "rgba(0, 0, 0, 0.9)",
    }; // Siyah Elit
  };
  ...
  // Örnek Kullanım:
  const { borderColorMovies, shadowColorMovies, borderColor2Movies } =
    getRankColor(totalMinutesTime + totalMinutesTimeTv);
