...
export const ProfileScreenProvider = ({ children }) => {
  ...
  const getRankColorTv = (totalWatchedTime) => {
    if (totalWatchedTime < 20160)
      return {
        borderColorTv: "#A9A9A9",
        borderColor2Tv: "#D3D3D3",
        shadowColorTv: "rgba(169, 169, 169, 0.9)",
      }; // Gri - Başlangıç
    if (totalWatchedTime < 40320)
      return {
        borderColorTv: "#cd7f32",
        borderColor2Tv: "#b87333",
        shadowColorTv: "rgba(205, 127, 50, 0.9)",
      }; // Bronz
    if (totalWatchedTime < 60480)
      return {
        borderColorTv: "#C0C0C0",
        borderColor2Tv: "#DCDCDC",
        shadowColorTv: "rgba(192, 192, 192, 0.9)",
      }; // Gümüş
    if (totalWatchedTime < 80640)
      return {
        borderColorTv: "#FFD700",
        borderColor2Tv: "#FFC300",
        shadowColorTv: "rgba(255, 215, 0, 0.9)",
      }; // Altın
    if (totalWatchedTime < 100800)
      return {
        borderColorTv: "#50C878",
        borderColor2Tv: "#32CD99",
        shadowColorTv: "rgba(80, 200, 120, 0.9)",
      }; // Zümrüt
    if (totalWatchedTime < 120960)
      return {
        borderColorTv: "#0F52BA",
        borderColor2Tv: "#1E90FF",
        shadowColorTv: "rgba(15, 82, 186, 0.9)",
      }; // Safir
    if (totalWatchedTime < 140160)
      return {
        borderColorTv: "#B9F2FF",
        borderColor2Tv: "#E0FFFF",
        shadowColorTv: "rgba(185, 242, 255, 0.9)",
      }; // Elmas
    if (totalWatchedTime < 160320)
      return {
        borderColorTv: "#9966cc",
        borderColor2Tv: "#BA55D3",
        shadowColorTv: "rgba(153, 102, 204, 0.9)",
      }; // Amethyst
    if (totalWatchedTime < 180480)
      return {
        borderColorTv: "#FF4500",
        borderColor2Tv: "#FF6347",
        shadowColorTv: "rgba(255, 69, 0, 0.9)",
      }; // Kızıl
    if (totalWatchedTime < 200640)
      return {
        borderColorTv: "#8A2BE2",
        borderColor2Tv: "#9370DB",
        shadowColorTv: "rgba(138, 43, 226, 0.9)",
      }; // Galaksi
    if (totalWatchedTime < 220800)
      return {
        borderColorTv: "#FF1493",
        borderColor2Tv: "#FF69B4",
        shadowColorTv: "rgba(255, 20, 147, 0.9)",
      }; // Pembe
    if (totalWatchedTime < 240960)
      return {
        borderColorTv: "#7FFFD4",
        borderColor2Tv: "#66CDAA",
        shadowColorTv: "rgba(127, 255, 212, 0.9)",
      }; // Akuamarin
    if (totalWatchedTime < 261120)
      return {
        borderColorTv: "#00CED1",
        borderColor2Tv: "#40E0D0",
        shadowColorTv: "rgba(0, 206, 209, 0.9)",
      }; // Turkuaz
    if (totalWatchedTime < 281280)
      return {
        borderColorTv: "#FF69B4",
        borderColor2Tv: "#FFB6C1",
        shadowColorTv: "rgba(255, 105, 180, 0.9)",
      }; // Tatlı Pembe
    if (totalWatchedTime < 301440)
      return {
        borderColorTv: "#DC143C",
        borderColor2Tv: "#B22222",
        shadowColorTv: "rgba(220, 20, 60, 0.9)",
      }; // Koyu Kırmızı
    return {
      borderColorTv: "#000000",
      borderColor2Tv: "#434343",
      shadowColorTv: "rgba(0, 0, 0, 0.9)",
    }; // Siyah Elit
  };
  const getRankColorMovie = (totalWatchedTime) => {
    if (totalWatchedTime < 10080)
      return {
        borderColorMovie: "#A9A9A9",
        borderColor2Movie: "#D3D3D3",
        shadowColorMovie: "rgba(169, 169, 169, 0.9)",
      }; // Gri - Başlangıç
    if (totalWatchedTime < 20160)
      return {
        borderColorMovie: "#cd7f32",
        borderColor2Movie: "#b87333",
        shadowColorMovie: "rgba(205, 127, 50, 0.9)",
      }; // Bronz
    if (totalWatchedTime < 30240)
      return {
        borderColorMovie: "#C0C0C0",
        borderColor2Movie: "#DCDCDC",
        shadowColorMovie: "rgba(192, 192, 192, 0.9)",
      }; // Gümüş
    if (totalWatchedTime < 40320)
      return {
        borderColorMovie: "#FFD700",
        borderColor2Movie: "#FFC300",
        shadowColorMovie: "rgba(255, 215, 0, 0.9)",
      }; // Altın
    if (totalWatchedTime < 50400)
      return {
        borderColorMovie: "#50C878",
        borderColor2Movie: "#32CD99",
        shadowColorMovie: "rgba(80, 200, 120, 0.9)",
      }; // Zümrüt
    if (totalWatchedTime < 60480)
      return {
        borderColorMovie: "#0F52BA",
        borderColor2Movie: "#1E90FF",
        shadowColorMovie: "rgba(15, 82, 186, 0.9)",
      }; // Safir
    if (totalWatchedTime < 70560)
      return {
        borderColorMovie: "#B9F2FF",
        borderColor2Movie: "#E0FFFF",
        shadowColorMovie: "rgba(185, 242, 255, 0.9)",
      }; // Elmas
    if (totalWatchedTime < 80640)
      return {
        borderColorMovie: "#9966cc",
        borderColor2Movie: "#BA55D3",
        shadowColorMovie: "rgba(153, 102, 204, 0.9)",
      }; // Amethyst
    if (totalWatchedTime < 90720)
      return {
        borderColorMovie: "#FF4500",
        borderColor2Movie: "#FF6347",
        shadowColorMovie: "rgba(255, 69, 0, 0.9)",
      }; // Kızıl
    if (totalWatchedTime < 100800)
      return {
        borderColorMovie: "#8A2BE2",
        borderColor2Movie: "#9370DB",
        shadowColorMovie: "rgba(138, 43, 226, 0.9)",
      }; // Galaksi
    if (totalWatchedTime < 110880)
      return {
        borderColorMovie: "#FF1493",
        borderColor2Movie: "#FF69B4",
        shadowColorMovie: "rgba(255, 20, 147, 0.9)",
      }; // Pembe
    if (totalWatchedTime < 120960)
      return {
        borderColorMovie: "#7FFFD4",
        borderColor2Movie: "#66CDAA",
        shadowColorMovie: "rgba(127, 255, 212, 0.9)",
      }; // Akuamarin
    if (totalWatchedTime < 130080)
      return {
        borderColorMovie: "#00CED1",
        borderColor2Movie: "#40E0D0",
        shadowColorMovie: "rgba(0, 206, 209, 0.9)",
      }; // Turkuaz
    if (totalWatchedTime < 140160)
      return {
        borderColorMovie: "#FF69B4",
        borderColor2Movie: "#FFB6C1",
        shadowColorMovie: "rgba(255, 105, 180, 0.9)",
      }; // Tatlı Pembe
    if (totalWatchedTime < 150240)
      return {
        borderColorMovie: "#DC143C",
        borderColor2Movie: "#B22222",
        shadowColorMovie: "rgba(220, 20, 60, 0.9)",
      }; // Koyu Kırmızı
    return {
      borderColorMovie: "#000000",
      borderColor2Movie: "#434343",
      shadowColorMovie: "rgba(0, 0, 0, 0.9)",
    }; // Siyah Elit
  };
  ...
  const { borderColorTv, shadowColorTv, borderColor2Tv } =
    getRankColorTv(totalMinutesTimeTv);
  console.log(totalMinutesTime);
  const { borderColorMovie, shadowColorMovie, borderColor2Movie } =
    getRankColorMovie(totalMinutesTime);
