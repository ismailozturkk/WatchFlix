...
export const ProfileScreenProvider = ({ children }) => {
  ...
  const getRankColorTv = (totalWatchedTime) => {
    const ranks = [
      {
        limit: 20160,
        colors: ["#A9A9A9", "#D3D3D3", "rgba(169, 169, 169, 0.9)"],
      }, // Gri - Başlangıç
      {
        limit: 40320,
        colors: ["#cd7f32", "#b87333", "rgba(205, 127, 50, 0.9)"],
      }, // Bronz
      {
        limit: 60480,
        colors: ["#C0C0C0", "#DCDCDC", "rgba(192, 192, 192, 0.9)"],
      }, // Gümüş
      {
        limit: 80640,
        colors: ["#FFD700", "#FFC300", "rgba(255, 215, 0, 0.9)"],
      }, // Altın
      {
        limit: 100800,
        colors: ["#50C878", "#32CD99", "rgba(80, 200, 120, 0.9)"],
      }, // Zümrüt
      {
        limit: 120960,
        colors: ["#0F52BA", "#1E90FF", "rgba(15, 82, 186, 0.9)"],
      }, // Safir
      {
        limit: 140160,
        colors: ["#B9F2FF", "#E0FFFF", "rgba(185, 242, 255, 0.9)"],
      }, // Elmas
      {
        limit: 160320,
        colors: ["#9966cc", "#BA55D3", "rgba(153, 102, 204, 0.9)"],
      }, // Amethyst
      {
        limit: 180480,
        colors: ["#FF4500", "#FF6347", "rgba(255, 69, 0, 0.9)"],
      }, // Kızıl
      {
        limit: 200640,
        colors: ["#8A2BE2", "#9370DB", "rgba(138, 43, 226, 0.9)"],
      }, // Galaksi
      {
        limit: 220800,
        colors: ["#FF1493", "#FF69B4", "rgba(255, 20, 147, 0.9)"],
      }, // Pembe
      {
        limit: 240960,
        colors: ["#7FFFD4", "#66CDAA", "rgba(127, 255, 212, 0.9)"],
      }, // Akuamarin
      {
        limit: 261120,
        colors: ["#00CED1", "#40E0D0", "rgba(0, 206, 209, 0.9)"],
      }, // Turkuaz
      {
        limit: 281280,
        colors: ["#FF69B4", "#FFB6C1", "rgba(255, 105, 180, 0.9)"],
      }, // Tatlı Pembe
      {
        limit: 301440,
        colors: ["#DC143C", "#B22222", "rgba(220, 20, 60, 0.9)"],
      }, // Koyu Kırmızı
    ];

    const rank = ranks.find((r) => totalWatchedTime < r.limit);

    const [borderColorTv, borderColor2Tv, shadowColorTv] = rank
      ? rank.colors
      : ["#000000", "#434343", "rgba(0, 0, 0, 0.9)"]; // Siyah Elit

    return { borderColorTv, borderColor2Tv, shadowColorTv };
  };
