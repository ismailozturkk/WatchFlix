...
const SWIPE_LIMIT = width * 0.3; // Kart ne kadar kaydırılabilir
const SWIPE_THRESHOLD = width * 0.2; // Aksiyon alınma eşiği
  ...
  return (
    <View style={styles.container}>
      ...
      <Animated.View
        style={[
          styles.action,
          { left: 20, backgroundColor: "#4CAF50", opacity: opacityLeft },
        ]}
      >
        <Pressable>
      ...
      <Animated.View
        style={[
          styles.action,
          { right: 20, backgroundColor: "#F44336", opacity: opacityRight },
        ]}
      >
        <Pressable>
