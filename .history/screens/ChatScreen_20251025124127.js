      ...
      <View style={{ flex: 1 }}>
        ...
        >
          {searchResults.length > 0 && (
            <FlatList
              ...
              renderItem={({ item }) => (
                <TouchableOpacity
                  onPress={() => {
                    // istersen seçilen sonucu mesaj olarak gönderebilirsin veya detay açabilirsin
                    console.log(item);
                  }}
                  style={{
                    padding: 10,
                ...
                >
                  <Text style={{ color: theme.text.primary }}>
                    {item.title || item.name || "Bilinmiyor"} ({item.media_type}
                    )
                  </Text>
                </TouchableOpacity>
              )}
          ...
          {searchOption && (
            ...
            >
              <TouchableOpacity
                onPress={() => fetchSearchResults("movie")}
                style={{
              ...
              >
                <Text style={{ color: theme.text.primary }}>merhaba</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={{
                  backgroundColor: theme.border,
