...
export default function ChatScreen({ route, navigation }) {
  ...
  }, [chatData.messages, chatData.friendTyping]);
    ...
    >
      <View style={{ flex: 1, backgroundColor: theme.primary }}>
        ...
        >
          ...
          >
            {chatData.friendInChat
              ? "Sohbette"
              : chatData.friendIsOnline
                ? "Çevrimiçi"
                : `Son görülme: ${chatData.friendLastSeen ? formatDate(chatData.friendLastSeen) : "bilinmiyor"}`}
          </Text>
        </View>
