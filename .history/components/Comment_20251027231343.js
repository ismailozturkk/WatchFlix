...
const InputArea = ({
  ...
  >
    ...
    >
      ...
      <SwitchToggle size={18} value={isSpoiler} onValueChange={setIsSpoiler} />
      <Switch
...
const Comment = ({ contextId }) => {
  ...
  }, [newComment, isSpoiler, currentUser, contextId]); // Bağımlılıkları ekledik

  // Bu fonksiyon basit olduğu için useCallback zorunlu değil ama tutarlılık için iyi.
