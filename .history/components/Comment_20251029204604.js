  ...
  ({
    ...
    const handleDeleteComment = async (commentId) => {
      try {
        ...
        // Opsiyonel: Eğer comment'in reply'leri varsa onları da silmek istiyorsan:
...
const Comment = ({ contextId }) => {
  ...
  //!--------------------------------------------------------------
  const handleEditComment = async (commentId, newText, isSpoilerValue) => {
    ...
    try {
      ...
      await updateDoc(commentRef, {
        text: newText.trim(),
        isSpoiler: isSpoilerValue,
        editedAt: serverTimestamp(), // opsiyonel: düzenleme zamanı
      });
    } catch (err) {
      console.error("Yorum düzenlenirken hata:", err);
    }
  };
  const handleEditReply = async (
    ...
    try {
      ...
      console.error("Yanıt düzenlenirken hata:", err);
    }
  };
  //!--------------------------------------------------------------
