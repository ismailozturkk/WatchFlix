            ...
            {!commentInputState.isReply && commentInputState.editId && (
              <View>
                <Text style={{ color: theme.text.secondary }}>
                  {commentInputState.replieName} Yazı Düzenleniyor
                </Text>
              </View>
            )}
            {commentInputState.isReply && !commentInputState.editId && (
              <View>
                <Text style={{ color: theme.text.secondary }}>
                  {commentInputState.replieName} cevap yazılıyor...
                </Text>
                <Text style={{ color: theme.text.secondary }}>
                  {commentInputState.replieText}
                </Text>
              </View>
            )}
            {commentInputState.isReply && commentInputState.editId && (
              <View>
                <Text style={{ color: theme.text.secondary }}>
                  {commentInputState.replieName} cevap düzenleniyor...
                </Text>
                <Text style={{ color: theme.text.secondary }}>
                  {commentInputState.replieText}
                </Text>
